            ...
            <el-form-item label="所在地区" prop="areaId">
                ...
                <el-row>
                    <el-col :span="8">
                            ...
                            <el-select v-model="ruleForm.provinceId" placeholder="请选择" size="mini" @change="getCity">
                                <el-option
                    ...
                    <el-col :span="8">
                        <div>
                            <el-select v-model="ruleForm.cityId" placeholder="请选择" size="mini" @change="getArea">
                                <el-option
