<template>
    <div>
      ...
      <span style="font-size:18px;font-weight: bold">
        已为您找到
        <span style="color: #39ac6a">{{this.$store.state.globalTotal  > 0 ? this.$store.state.globalTotal :0}}</span>
        ...
        <div>
            <el-tabs :tab-position="top">
                <el-tab-pane label="默认排序">
                    <div>
                        <ul class="houseList" v-if="$store.state.houseList.length>0">
                    ...
                    <div>
                        ...
                        <el-pagination
                                ...
                                :total="this.$store.state.globalTotal"
                        ></el-pagination>
                    </div>
                </el-tab-pane>
                <el-tab-pane label="最新发布">
                    <div>
                        <ul class="houseList" v-if="$store.state.houseListNewest.length>0">
                ...
                <el-tab-pane label="按价格升序">
                    <div>
                        <ul class="houseList" v-if="$store.state.houseListByPrice.length>0">
                ...
                <el-tab-pane label="按面积升序">
                    <div>
                        <ul class="houseList" v-if="$store.state.houseListByArea.length>0">
...
<script>
    ...
    export default {
        ...
        created() {
            this.$store.state.houseList = [];
            this.$store.state.houseListNewest = [];
            this.$store.state.houseListByPrice = [];
            this.$store.state.houseListByArea = [];
            this.$store.state.globalTotal = 0;
        }
    };
</script>
