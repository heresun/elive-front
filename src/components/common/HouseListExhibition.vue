<template>
    <div>
        <el-button @click="testVal">test</el-button>
        <!-- 这里是条件筛选部分-->
        <div id="container">
            <!--地区过滤-->
            <el-row>
            ...
            <el-row>
                ...
                <el-col :span="23" style="margin-top: 2px">
                    <el-checkbox v-model="priceC1"><span style="font-size: 12px">60万以下</span></el-checkbox>
                    <el-checkbox v-model="priceC2"><span style="font-size: 12px">60~90万</span></el-checkbox>
                    <el-checkbox v-model="priceC3"><span style="font-size: 12px">90~120万</span></el-checkbox>
                    <el-checkbox v-model="priceC4"><span style="font-size: 12px">120~160万</span></el-checkbox>
                    <el-checkbox v-model="priceC5"><span style="font-size: 12px">160~200万</span></el-checkbox>
                    <el-checkbox v-model="priceC6"><span style="font-size: 12px">200~250万</span></el-checkbox>
                    <el-checkbox v-model="priceC7"><span style="font-size: 12px">250~300万</span></el-checkbox>
                    <el-checkbox v-model="priceC8"><span style="font-size: 12px">300万以上</span></el-checkbox>
            ...
            <el-row>
                ...
                <el-col :span="23" style="margin-top: 2px">
                    <el-checkbox v-model="squareC1"><span style="font-size: 12px">60 m<sup> 2</sup>以下</span>
                    </el-checkbox>
                    <el-checkbox v-model="squareC2"><span style="font-size: 12px">60~100 m<sup> 2</sup></span>
                    </el-checkbox>
                    <el-checkbox v-model="squareC3"><span style="font-size: 12px">100~130 m<sup> 2</sup></span>
                    </el-checkbox>
                    <el-checkbox v-model="squareC4"><span style="font-size: 12px">130~160 m<sup> 2</sup></span>
                    </el-checkbox>
                    <el-checkbox v-model="squareC5"><span style="font-size: 12px">160~180 m<sup> 2</sup></span>
                    </el-checkbox>
                    <el-checkbox v-model="squareC6"><span style="font-size: 12px">180~200 m<sup> 2</sup></span>
                    </el-checkbox>
                    <el-checkbox v-model="squareC7"><span style="font-size: 12px">200 m<sup> 2</sup>以上</span>
                    </el-checkbox>
            ...
            <el-row>
                ...
                <el-col :span="23" style="margin-top: 2px">
                    <el-checkbox v-model="levelC1"><span style="font-size: 12px">低楼层(8楼以下)</span></el-checkbox>
                    <el-checkbox v-model="levelC2"><span style="font-size: 12px">中楼层(8~20楼)</span></el-checkbox>
                    <el-checkbox v-model="levelC3"><span style="font-size: 12px">高楼层(20楼以上)</span></el-checkbox>
            ...
            <el-row>
                ...
                <el-col :span="23" style="margin-top: 5px">
                    <el-checkbox v-model="orienC1"><span style="font-size: 12px">朝东</span></el-checkbox>
                    <el-checkbox v-model="orienC2"><span style="font-size: 12px">朝南</span></el-checkbox>
                    <el-checkbox v-model="orienC3"><span style="font-size: 12px">朝西</span></el-checkbox>
                    <el-checkbox v-model="orienC4"><span style="font-size: 12px">朝北</span></el-checkbox>
                </el-col>
            </el-row>
            ...
            <el-row>
                ...
                <el-col :span="23" style="margin-top: 5px">
                    <el-radio v-model="heatingType" label="1"><span style="font-size: 12px">集中供暖</span></el-radio>
                    <el-radio v-model="heatingType" label="2"><span style="font-size: 12px">自供暖</span></el-radio>
                </el-col>
            </el-row>
            ...
            <el-row>
                ...
                <el-col :span="23" style="margin-top: 5px">
                    <el-radio v-model="parkLot" label="1"><span style="font-size: 12px">无</span></el-radio>
                    <el-radio v-model="parkLot" label="2"><span style="font-size: 12px">有</span></el-radio>
                </el-col>
            </el-row>
        ...
        <div style="margin-top: 50px">
            <span style="font-size:18px;font-weight: bold">已为您找到<span style="color: #39ac6a">{{total > 0 ? total:0}}</span>套租房</span>
        </div>
        <div>
            <el-tabs :tab-position="top">
                <el-tab-pane label="默认排序">
                    <ul class="houseList">
                        <li v-for="item in houseList" :key="item">
                ...
                <el-tab-pane label="最新发布">
                    ...
                    <ul class="houseList">
                        <li v-for="item in houseListNewest" :key="item">
                            <ListRownCmp :house="item"></ListRownCmp>
                            <el-divider></el-divider>
                        </li>
                    </ul>
                ...
                <el-tab-pane label="按价格升序">
                    <ul class="houseList">
                        <li v-for="item in houseListByPrice" :key="item">
                            <ListRownCmp :house="item"></ListRownCmp>
                            <el-divider></el-divider>
                        </li>
                    </ul>
                ...
                <el-tab-pane label="按面积升序">
                    <ul class="houseList">
                        <li v-for="item in houseListByArea" :key="item">
                            <ListRownCmp :house="item"></ListRownCmp>
                            <el-divider></el-divider>
                        </li>
                    </ul>
        ...
        methods: {
            ...
            getNewPage(form) {
                ...
                this.$axios.post(this.url, form).then(res => {
                    this.houseList = res.data.housePage;
            ...
            getNewPageNewest(form) {
                ...
                this.$axios.post(this.url, innerForm).then(res => {
                    this.houseListNewest = res.data.housePage;
                    this.total = res.data.houseCount;
            ...
            getNewPageByPriceAesc(form) {
                ...
                this.$axios.post(this.url, innerForm).then(res => {
                    this.houseListByPrice = res.data.housePage;
                    this.total = res.data.houseCount;
            ...
            getNewPageByAreaAesc(form) {
                ...
                this.$axios.post(this.url, innerForm).then(res => {
                    this.houseListByArea = res.data.housePage;
                    this.total = res.data.houseCount;
            ...
            getArea() {
                this.$axios("/district/location.do?pId=" + this.cityId).then(res => {
                    this.areas = res.data;
                }).catch(err => {
                    console.log(err);
                });
