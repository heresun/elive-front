          ...
          <div>
            ...
            >
              ...
              <el-form-item label="房屋布局" required>
                <el-input v-model="ruleForm.bedroom" class="layout" @focus="forceLogin"></el-input>居室
                <el-input v-model="ruleForm.livingroom" class="layout" @focus="forceLogin"></el-input>客厅
                <el-input v-model="ruleForm.kitchen" class="layout" @focus="forceLogin"></el-input>厨房
                <el-input v-model="ruleForm.bathroom" class="layout" @focus="forceLogin"></el-input>卫生间
              </el-form-item>
